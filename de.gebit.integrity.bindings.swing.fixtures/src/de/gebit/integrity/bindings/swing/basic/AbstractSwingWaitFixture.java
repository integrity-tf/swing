 ...
 * 
 * @param <C>
 *            the component type (not actually used for anything right now)
 * 
 * @author Rene Schneider - initial API and implementation
 * 
 */
public abstract class AbstractSwingWaitFixture<C extends JComponent> extends AbstractSwingFixture<JComponent> {
