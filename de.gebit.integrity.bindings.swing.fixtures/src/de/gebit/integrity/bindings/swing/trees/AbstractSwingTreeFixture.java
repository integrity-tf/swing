...
public abstract class AbstractSwingTreeFixture<C extends JTree> extends AbstractSwingFixture<C> implements
	 ...
	 */
	@FixtureMethod(descriptionCall = "Get the number of {" + TREE_ITEM_PATH_PARAMETER_NAME + "?childs of item '$"
	...
	public Integer getTreeChildCount(@FixtureParameter(name = COMPONENT_PATH_PARAMETER_NAME) String aComponentPath,
